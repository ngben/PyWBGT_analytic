...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python calculate_wbgt_aus10i_ssp126.py <year>")
        sys.exit(1)
...
#    BASE_DIR = '/g/data/hq89/CCAM/output/CMIP6/DD/AUS-10i/CSIRO/ACCESS-CM2/ssp126/r4i1p1f1/CCAM-v2203-SN/v1-r1/1hr'
#    version = 'v20231206'
