...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python calculate_wbgt_aus10i_ssp370_noleap.py <year>")
        sys.exit(1)
    ...
    BASE_DIR = f'/g/data/xv83/CCAM/output/CMIP6/DD/AUS-10i/CSIRO/{model}/ssp370/{experiment}/CCAM-v2203-SN/v1-r1/1hr'
    version = 'v20250912'
    ...
    for year in years:
        ...
        outdir = f"/scratch/e53/bxn599/aus10i/{model}_ssp370"
        os.makedirs(outdir, exist_ok=True)

        tnw_outfile = f"{outdir}/tnw_AUS-10i_{model}_ssp370_{experiment}_CSIRO_CCAM-v2203-SN_v1-r1_1hr_{year}01010000-{year}12312300.nc"
        tg_outfile = f"{outdir}/tg_AUS-10i_{model}_ssp370_{experiment}_CSIRO_CCAM-v2203-SN_v1-r1_1hr_{year}01010000-{year}12312300.nc"
        wbgt_outfile = f"{outdir}/wbgt_AUS-10i_{model}_ssp370_{experiment}_CSIRO_CCAM-v2203-SN_v1-r1_1hr_{year}01010000-{year}12312300.nc"
